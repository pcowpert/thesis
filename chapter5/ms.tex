...
\enddata
\tablecomments{Summary of photometry from \autoref{sec:observations}. Dates are give in days relative to the time of the GW trigger (MJD = 57982.529). Photometry {\it is not} corrected for extinction. Limits are given at the $3\sigma$ level. Error bars are given at the $1\sigma$ level.}
\end{deluxetable}
