...
the observations is provided in \cref{datatable} and a visual
...
third epochs to search for significant fading\footnote{We note that this
...
\citeyearpar{ss+16} quantified this effect by injecting fake sources into
...
and DEC = $-$02\arcdeg13\arcmin42 6\arcsec~(J2000), with an offset of $5.8$ arcsec from the galaxy
CGCG 386-030 (RA =  01$^{\rm h}$42$^{\rm m}$15$^{\rm s}$.6, DEC = $-$02\arcdeg13\arcmin38
5\arcsec; J2000), at $z = 0.041$ or $d_L \approx 187$ Mpc (6dFGS, \citealt{Jones+04,Jones+09}); see
\Cref{fig:ch4_PS15cdi}. We note that this distance is inconsistent with the 90\% confidence interval for
...
kilonova model with ejecta parameters of $v_{\rm ej} = 0.2$c and $M_{\rm ej} = 0.1$ M$_\odot$
 ...
 and models are shown in \Cref{fig:ch4_PS15cdi}.
